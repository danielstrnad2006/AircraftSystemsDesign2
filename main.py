...
if True: #input("Start with detailed analysis of critical conditions? (y)")=="y":
    for cond in crit_conds:
        ...
        n_stringers_one_side = len(stiffeners_areas)/2
        skin_buckling_safety = Skin_buckling(ribs_locations, [sigma/1e6 for sigma in sigma_lst], thickness_input=spar_thickness[2]*1e-3, n_stringers=n_stringers_one_side)[1]
